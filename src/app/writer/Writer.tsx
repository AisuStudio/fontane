...
export default function Writer() {
  ...
  return (
    // Now a real view (topMode==="draw", drawStyle==="writer") rendered
    // straight into page.tsx's .main, same as Grid/Free/EditorPanel — the
    // menu bar, view tabs, BetaBadge, and Tools row are all page.tsx's own
    // chrome now, shared with every other view instead of duplicated here.
    // This root just needs to fill and scroll within whatever space .main
    // gives it (flex:1, overflow:hidden on .main itself).
